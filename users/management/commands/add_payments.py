...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        user, _ = User.objects.get_or_create(email='test1@mail.ru', phone='+79876541232', city='Москва')
        ...
        for payment_data in payments:
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f'successfully added payment: {payment.payment_amount}'))
            else:
                self.stdout.write(self.style.WARNING(f'payment already exists: {payment.payment_amount}'))
...
class Course(models.Model):
    ...
    preview = models.ImageField(upload_to="courses_preview/", verbose_name="превью", null=True, blank=True)
    ...
    last_notification_sent = models.DateTimeField(verbose_name="дата отправки последнего уведомления", null=True, blank=True)
...
class Lesson(models.Model):
    ...
    preview = models.ImageField(upload_to="lessons_preview", verbose_name="превью", null=True, blank=True)

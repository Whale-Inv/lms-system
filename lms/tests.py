...
class LessonTestCase(APITestCase):
    ...
    def test_create_lesson(self):
        ...
        self.assertEqual(
            response.json(),
            {'id': 2, 'name': 'Тестовый урок', 'description': 'Описание тестового урока', 'preview': None,
             'link': 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', 'course': 1, 'owner': 1}
        )
    ...
    def test_list_lessons(self):
        ...
        self.assertEqual(lesson_data['link'], 'https://www.youtube.com/watch?v=dQw4w9WgXcQ')
